globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/h3/dist/index.mjs';
import mongoose, { Schema, model } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/mongoose/index.js';
import { createRenderer } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/scule/dist/index.mjs';
import { hash } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/ufo/dist/index.mjs';
import { createStorage } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/node_modules/radix3/dist/index.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{},"mongodbUri":""};
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/admin/Documents/hummaction Offi/hummastock/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\admin\\Documents\\hummaction Offi\\hummastock","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\admin\\Documents\\hummaction Offi\\hummastock\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\admin\\Documents\\hummaction Offi\\hummastock\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\admin\\Documents\\hummaction Offi\\hummastock\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _Hs2Py6udkT = async (_nitroApp) => {
  const config = useRuntimeConfig();
  try {
    mongoose.connect(config.mongodbUri).then(() => console.log("Base de donn\xE9e connect\xE9e"));
  } catch (e) {
    console.log("\xC9chec de connexion \xE0 la base de donn\xE9e" + e);
  }
...
const _lazy_gGmP7n = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_MX79Sv = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/produits', handler: _lazy_gGmP7n, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_MX79Sv, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_MX79Sv, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/admin/Documents/hummaction%20Offi/hummastock/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
